export const MILESTONES = [
  ...
  { name: 'Growing village', population: 120, reward: 2200, unlocks: 'Clinic and elementary school' },
  { name: 'Small town', population: 400, reward: 4000, unlocks: 'Fire, police, recycling, buses, sewage treatment and city entrances' },
  { name: 'Thriving town', population: 900, reward: 6500, unlocks: 'Solar farm, offices and high-rise growth' },
  { name: 'City', population: 1800, reward: 9000, unlocks: 'University and passenger rail' },
