...
const I: Record<string, string> = {
  cemetery: '<path d="M8 21v-9a4 4 0 0 1 8 0v9M12 10v5M10 12h4M3 21h18"/>',
  crematorium: '<path d="M3 21V11h12v10M15 21V5h4v16M6 15h6M2 21h20M17 5V3"/>',
  postoffice: '<path d="M3 6h18v12H3zM3 6l9 7 9-7"/>',
  barrier: '<path d="M2 20q2.5-2 5 0t5 0 5 0 5 0M4 16V6h16v10M4 10h16"/>',
  parking: '<path d="M4 3h16v18H4zM10 17V7h3a3 3 0 0 1 0 6h-3"/>',
  parkingm: '<path d="M3 3h18v18H3zM10 17V7h3a3 3 0 0 1 0 6h-3"/>',
  parkingl: '<path d="M2 5h20v14H2zM10 16V8h3a2.5 2.5 0 0 1 0 5h-3"/>',
  landmark: '<path d="M12 2v3M9 9h6l-1-4h-4zM10 9l-1 12h6l-1-12M6 21h12"/>',
  districts: '<path d="M3 4h7v7H3zM14 4h7v7h-7zM3 15h7v6H3zM14 15h7v6h-7z"/>',
  district: '<path d="M3 4h7v7H3zM14 4h7v7h-7zM3 15h7v6H3zM14 15h7v6h-7z"/>',
  undistrict: '<path d="M3 4h7v7H3zM14 15h7v6h-7zM14 4l7 7M21 4l-7 7"/>',
  dig: '<path d="M14 4l6 6M17 7 7 17M5 21l2-4 3 3zM3 21h8"/>',
  fill: '<path d="M3 20h18M5 20l3-8h8l3 8M9 8a3 3 0 0 1 6 0"/>',
  land: '<path d="M2 20 9 9l4 6 3-4 6 9z"/>',
  ...
  addlane: '<path d="M6 21 8 3M13 21V3"/><path d="M19 12v6M16 15h6"/><path d="M10.5 5v2M10.5 11v2M10.5 17v2"/>',
  ...
  drive: '<path d="M5 17h14M4 17v-4l2-5h12l2 5v4"/><path d="M4 13h16"/><circle cx="7.5" cy="17.5" r="1.5"/><circle cx="16.5" cy="17.5" r="1.5"/>',
  farm: '<path d="M3 21h18M5 21V11l5-4 5 4v10"/><path d="M8 21v-5h4v5"/><path d="M17 21V8a2 2 0 0 1 4 0v13"/>',
  leisure: '<path d="M4 21h16M6 21V9h12v12"/><path d="M4 9l8-5 8 5"/><path d="M10 13h4M10 17h4"/><circle cx="12" cy="6.5" r=".6"/>',
  ...
  'ring-double': '<circle cx="12" cy="12" r="6.5"/><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="1.5"/>',
  'ring-grand': '<circle cx="12" cy="12" r="9.5"/><circle cx="12" cy="12" r="7"/><circle cx="12" cy="12" r="2.5"/>',
